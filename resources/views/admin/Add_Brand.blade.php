...
<div class="h_products_list clearfix mb20" id="Sellerber">
  <div class="Sellerber_left menu" id="menuBar">
    ...
    <div class="list_content">
     <div class="side_list">
      ...
      <li class=" clearfix"><label class="label_name"><i>*</i>系列名称：</label> <input name="cat_name" type="text" class="add_text" style="width:220px"/></li>
       <li class=" clearfix"><label class="label_name"><i>*</i>系列logo：</label>
         ...
         <li class=" clearfix"><label class="label_name"><i>*</i>关键字：</label> <input name="desc" type="text" class="add_text" style="width:220px"/></li>
         <li class=" clearfix"><label class="label_name"><i>*</i>系列描述：</label> <textarea name="cat_desc" cols="" rows="" class="textarea" onkeyup="checkLength(this);"></textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">500</span>字</span></li>
       </ul>
     </div>
 ...
 <input name="" type="submit"  class="btn button_btn bg-deep-blue" value="添加分类"/>
 <input name="" type="reset" value="取消添加" class="btn button_btn btn-Dark-success"/>
</div>
</div>
</form>
</body>

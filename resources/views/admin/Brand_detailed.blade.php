...
<div class="margin clearfix" id="page_style">
  ...
  <div class="brand_info clearfix">
   ...
   <form>
    ...
    <div class="brand_logo">
      <img src="{{asset('admin')}}/product_img/logo/1270.jpg"  width="120px" height="60px"/>
      <p class="name">darryring</p>
    </div>
   </form>
   </div>
	</div>
 ...
 <div class="operation clearfix mb15  searchs_style">
       <span class="l_f">
        <a href="{{url('admin/add_product')}}"  title="添加商品" class="btn bg-deep-blue button_btn"><i class="fa fa-plus"></i>添加商品</a>

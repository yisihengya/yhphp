...
<div class="add_style clearfix relative">
 ...
 <ul>
  ...
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>简单描述：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="goods_describe" type="text" class="col-xs-4"/></div></li>
   <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>关&nbsp;键&nbsp;字：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="goods_keyword" type="text" class="col-xs-4"/><em class="Prompt"> 请用","分隔关键字</em></div></li>
    ...
    <input name="original_price" type="text"  class="col-xs-7"/><em class="Prompt">元</em>
    </div>   
    </div>
    <div class="col-xs-4">
    <label class="label_name col-xs-3"><i>*</i>商品现价：&nbsp;&nbsp;</label> 
    <div class="Add_content col-xs-9">
   <input name="now_price" type="text"  class="col-xs-7"/><em class="Prompt">元</em>
    </div>   
    </div>
    <div class="col-xs-4">
    <label class="label_name col-xs-3"><i>*</i>商品数量：&nbsp;&nbsp;</label> 
    <div class="Add_content col-xs-9">
   <input name="goods_num" type="text"  class="col-xs-7"/><em class="Prompt">件</em>
    </div>   
    </div>
    </li>
   <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>设置时间：&nbsp;&nbsp;</label>
    ...
    <div class="Date_selection" style="display:none">
      <span class="label_name">开始日：</span><input type="text" class="laydate-icon" id="start" name="start_time" style="width:200px; margin-right:10px; height:30px; line-height:30px; float:left">
      <span class="label_name">结束日：</span><input type="text" class="laydate-icon" id="end" name="end_time" style="width:200px;height:30px; line-height:30px; float:left">
    </div>
    </div>   
    </li>
    <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>设置规格：&nbsp;&nbsp;</label>
    <div class="Add_content col-xs-11">    
       <input name="goods_norm" type="text"  class="col-xs-6"/><em class="Prompt">如"颜色,尺寸,型号"中间以英文逗号隔开</em>
    </div>   
    </li>
     <li class="clearfix">
      <div class="col-xs-4">
    ...
    <label class="l_f checkbox_time"><input type="checkbox" name="is_pl" class="ace" checked="checked" value="1"><span class="lbl"></span></label>
     ...
     <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>商品编号：&nbsp;&nbsp;</label>
         <div class="Add_content col-xs-5">
             <input name="goods_nums" type="text"  class="col-xs-6"/>
         </div>
     </li>
     {{--商品主图上传--}}
     <li class=" clearfix"><label class="label_name col-xs-1"><i>*</i>商品主图：</label>
         <div class="up_load_img">
             ...
             <img src="{{asset('dantuuploader/images')}}/1.jpg" width="160" height="160" id="photoimg" />
         </div><em class="Prompt" style="color: slateblue;font-size: 16px">请点击图片选择需要上传的商品主图</em>
         {{--<div><input type="submit" value="上传"/></div>--}}
     </li>
     {{--多图上传--}}
     <label class="label_name" style="padding-left: 70px"><i>*</i>商品附图：</label>
     ...
     <div class="Add_content col-xs-11">
      <textarea rows="" cols="" name="goods_introduce" id="editor" style="width:100%;height:300px;"></textarea>
      </div>
     </li>  
 </ul>

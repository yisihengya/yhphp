            ...
            @foreach($res as $k=>$v)
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <a title="删除" href="javascript:;"  class="btn button_btn btn-danger" id="delete" data-id="{{$v->id}}">删除</a>
        ...
        <form action="" method="post" id="form-admin-add">
            ...
            <ul>
                ...
                <li class="clearfix">
                    ...
                    <div class="formControls col-xs-6">
                        <textarea name="remark" cols="" rows="" class="textarea col-xs-12" placeholder="说点什么...100个字符以内" dragonfly="true" onkeyup="checkLength(this);"></textarea>
...
alert(id);
            layer.confirm('您确定要删除吗？', {
                ...
                $.ajax({
                    url:"{{url('admin/administrator_list_delete')}}",
                    type:'post',
                    dataType:'json',
                    ...
                    success:function (res) {
                        if(res.code==0){
                            layer.msg(res.message, {icon: 1},function () {
                                location.href="{{url('admin/administrator_list')}}";
                            });
                        }else{

   ...
   <div class="operation clearfix same_module mb15">
       <form action="" method="post">
           {{csrf_field()}}
            ...
            <li class="clearfix col-xs-2 col-lg-2 col-ms-3 "><label class="label_name ">会员UID：</label><input name="uname" type="text"  class="form-control col-xs-6 col-lg-5"/></li>
            <button class="btn button_btn bg-deep-blue " onclick=""  type="submit"><i class="fa  fa-search"></i>&nbsp;查询</button>
        </ul>
       </form>
  </div>
   ...
   @foreach($sel as $v)
       <tr>
           ...
           <td class="td-manage">
               ...
               <a title="删除" href="javascript:;"  onclick="member_del(this,'{{$v->uid}}')" class="btn btn-xs btn-delete" >删除</a>
           </td>
       </tr>
   @endforeach
   </thead>

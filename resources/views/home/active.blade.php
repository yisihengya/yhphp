...
最新活动
  ...
  <meta content="format=html5; url=http://m.darryring.com/mactivity.aspx" name="mobile-agent" /> 
 </head>
 <body>
  <link href="{{asset('libs/home')}}/css/same.css?v=1.3.7.2" type="text/css" rel="stylesheet" />
  <link href="{{asset('libs/home')}}/css/newesthing.css?v=1.3.5" type="text/css" rel="stylesheet" />
  <script src="{{asset('libs/home')}}/js/jquery.js" type="text/javascript"></script>
  
  <form id="form1" action="{{url('home/public/active')}}" method="post" name="form1">
   ...
   <div class="cort"> 
    <!--最新动态--> 
    <div class="cmain newesthing"> 
     <div class="zbk_top spalid"> 
      <div class="zbk_top spalid"> 
       <span>您当前的位置：</span> 
       <span id="ctl05_SiteMapPath1"><a href="#ctl05_SiteMapPath1_SkipLink"></a><span> <a target="_blank" href="index.html">Darry Ring</a> </span><span> <em>&gt;</em> </span><span> <span>最新活动</span> </span><a id="ctl05_SiteMapPath1_SkipLink"></a></span> 
      </div> 
     </div> 
     <!--动态内容--> 
     <div class="newesthing_cort"> 
      <!--活动切换导航-->
      <ul class="newesthing_cort-nav">
       <li class="newesthing_cort-check" onClick="chstatus(this.id)" id="li_1">全部活动</li>
       <li onClick="chstatus(this.id)" id="li_2">进行中的活动</li>
       <li onClick="chstatus(this.id)" id="li_3">已结束的活动</li>
      </ul>
      <input type="submit" style="display:none" id="btnall" value="全部" name="btnall" /> 
      <input type="submit" style="display:none" id="btnJing" value="进行中活动" name="btnJing" /> 
      <input type="submit" style="display:none" id="btnOver" value="已结束" name="btnOver" /> 
      <!--活动切换导航end--> 
      <!--页数总数--> 
      <div class="newesthing_cort-parge"> 
       <p class="fl"> <span>共有<i id="lbtotal">26</i>个活动</span> </p> 
       <div class="talktop_left fr"> 
        <span>共<i id="lbcount">4</i>页</span> 
        <em>|</em> 
        <span><i id="lbcurrent">1</i>/<i id="lbzong">4</i></span> 
        <input type="submit" class="next_page" id="btnNext" value="下一页" name="btnNext" /> 
       </div> 
      </div> 
      <!--页数总数end--> 
      <!--各种活动--> 
      <div id="div_all"> 
       <div class="newesthing_cort-activities"> 
        <!--标题--> 
        <div class="newesthing_cort-activities-top"> 
         <div class="newesthing_cort-activities-tittle fl"> 
          <p> <strong>唐嫣佩戴Darry Ring璀璨臻品,拍摄《时尚新娘》大片</strong> <em>(进行中）</em></p> 
          <p> <span>活动时间：</span> <i>2015/5/27 0:00:00</i> <span class="line-padd">-</span> <i>2015/6/27 0:00:00</i> </p> 
         </div> 
         <div class="newesthing_cort-activities-tittle atittle-right fr"> 
          <p> <i>2031</i> <span>人参与了此项活动!</span> </p> 
         </div> 
        </div> 
        <!--标题end--> 
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <div> 
          <a target="_blank" href="index.html/ty.html"><img width="1000" height="330" src="{{url('libs/home')}}/images/201505291745509c39dad33b.jpg" alt="" /></a>
         </div> 
         <div>
           &nbsp;
         </div> 
         <div style="font-size:12px; color:#888888;"> 
          <span style=""><span style="font-family: Verdana, Arial, Helvetica, sans-serif; line-height: 22px; ">唐嫣首登《时尚新娘》六月刊封面，并佩戴一生仅能定制一枚的Darry Ring（DR真爱戒指）璀璨臻品，化为幸福小女人。了解更多请点击<a href="index.html/ty.html">index.html/ty.html</a></span></span>
         </div> 
         <p></p> 
        </div> 
       </div> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-top"> 
         <div class="newesthing_cort-activities-tittle fl"> 
          <p> <strong>娄艺潇佩戴Darry Ring登《芭莎珠宝》</strong> <em>(进行中）</em></p> 
          <p> <span>活动时间：</span> <i>2015/5/28 0:00:00</i> <span class="line-padd">-</span> <i>2015/6/25 0:00:00</i> </p> 
         </div> 
         <div class="newesthing_cort-activities-tittle atittle-right fr"> 
          <p> <i>3069</i> <span>人参与了此项活动!</span> </p> 
         </div> 
        </div> 
        <!--标题end--> 
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.html/lyx.html"><img width="1000" height="330" src="{{url('libs/home')}}/images/20150528143230053145c1a7.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p>
         <p> <span style="color: rgb(136, 136, 136); font-size: 12px;">在《芭莎珠宝》大片拍摄中，娄艺潇佩戴一生仅能定制一枚的DarryRing浪漫臻品，倾情演绎只因坚守真爱唯一的信念。更多详情点击<a href="index.html/lyx.html">index.html/lyx.html</a><br /> </span></p> 
         <p></p> 
        </div> 
       </div> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-top"> 
         <div class="newesthing_cort-activities-tittle fl"> 
          <p> <strong>Darry Ring苏州店即将开业</strong> <em>(进行中）</em></p> 
          <p> <span>活动时间：</span> <i>201/5/18 0:00:00</i> <span class="line-padd">-</span> <i>2015/6/12 0:00:00</i> </p>
         </div> 
         <div class="newesthing_cort-activities-tittle atittle-right fr"> 
          <p> <i>1329</i> <span>人参与了此项活动!</span> </p> 
         </div> 
        </div> 
        <!--标题end--> 
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.html/suzstore"><img width="1000" height="330" src="{{url('libs/home')}}/images/2015052115224001b3d91235.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p>
         <p> <span style="color: rgb(136, 136, 136); font-size: 12px;">Darry Ring即将坐落苏州，在江南水乡，以Darry Ring男人一生仅能定制一枚的执着，感受每一份真爱的柔情……<br /> </span></p> 
         <p></p> 
        </div> 
       </div> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-top"> 
         <div class="newesthing_cort-activities-tittle fl"> 
          <p> <strong>《小时代4》陆烧林萧求婚钻戒</strong> <em>(进行中）</em></p> 
          <p> <span>活动时间：</span> <i>2015/6/10 0:00:00</i> <span class="line-padd">-</span> <i>2015/7/10 0:00:00</i> </p> 
         </div> 
         <div class="newesthing_cort-activities-tittle atittle-right fr"> 
          <p> <i>26103</i> <span>人参与了此项活动!</span> </p> 
         </div> 
        </div> 
        <!--标题end--> 
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <div> 
          <a target="_blank" href="index.html/xiaoshidai4.html"><img width="1000" height="330" src="{{url('libs/home')}}/images/2015061114302742b5f2b237.jpg" alt="" /></a>
         </div> 
         <div>
           &nbsp;
         </div> 
         <div style="font-size:12px; color:#888888;"> 
          <span style=""><span style="font-family: Verdana, Arial, Helvetica, sans-serif; line-height: 22px; ">小时代4陆烧林萧求婚钻戒，Darry Ring钻戒顶级定制！无论是回到相爱的那一年，还是走到生命灵魂的尽头，陪伴才是一辈子最美的承诺。</span></span>
         </div> 
         <p></p> 
        </div> 
       </div> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-top"> 
         <div class="newesthing_cort-activities-tittle fl"> 
          <p> <strong>5.20送女朋友一生仅能送一枚的钻戒 娶她回家！</strong> <em>(已结束）</em></p> 
          <p> <span>活动时间：</span> <i>2015/5/13 0:00:00</i> <span class="line-padd">-</span> <i>2015/5/20 0:00:00</i> </p> 
         </div> 
         <div class="newesthing_cort-activities-tittle atittle-right fr"> 
          <p> <i>110069</i> <span>人参与了此项活动!</span> </p> 
         </div> 
        </div> 
        <!--标题end--> 
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.html/520.html"><img width="1000" height="330" src="{{url('libs/home')}}/images/20150513124231a10e2c5f1c.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p>
         <p> <span style="color: rgb(136, 136, 136); font-size: 12px;">520我想嫁，你敢娶吗？浪漫五月季，用男士一生仅一枚的Darry Ring（DR真爱戒指）向爱人告白，娶她回家吧！ <br /> </span></p> 
         <p></p> 
        </div> 
       </div> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-top"> 
         <div class="newesthing_cort-activities-tittle fl"> 
          <p> <strong>5.20，给她一份爱的礼物！</strong> <em>(已结束）</em></p> 
          <p> <span>活动时间：</span> <i>2015/5/15 0:00:00</i> <span class="line-padd">-</span> <i>2015/5/21 0:00:00</i> </p> 
         </div> 
         <div class="newesthing_cort-activities-tittle atittle-right fr"> 
          <p> <i>3692</i> <span>人参与了此项活动!</span> </p> 
         </div> 
        </div> 
        <!--标题end--> 
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.html/520fg.html"><img width="1000" height="330" src="{{url('libs/home')}}/images/20150515151308d1c34c620f.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p>
         <p> <span style="color: rgb(136, 136, 136); font-size: 12px;">结婚至今，你有多久没向她说出我爱你？520，给她一份爱的礼物吧，让Darry Ring继续为你说出每一天的爱意与真心！ <br /> </span></p> 
         <p></p> 
        </div> 
       </div> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-top"> 
         <div class="newesthing_cort-activities-tittle fl"> 
          <p> <strong>Darry Ring天津店即将开业</strong> <em>(进行中）</em></p> 
          <p> <span>活动时间：</span> <i>2015/5/20 0:00:00</i> <span class="line-padd">-</span> <i>2015/6/20 0:00:00</i> </p> 
         </div> 
         <div class="newesthing_cort-activities-tittle atittle-right fr"> 
          <p> <i>3600</i> <span>人参与了此项活动!</span> </p> 
         </div> 
        </div> 
        <!--标题end--> 
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.html/tjstore"><img width="1000" height="330" src="{{url('libs/home')}}/images/20150513103218ff0c3e5616.jpg" alt="Darry Ring武汉店即将开业" /></a><a target="_blank" href="index.html/csstore"><br /> </a></p>
         <p> <span style="color: rgb(136, 136, 136); font-size: 12px;">Darry Ring即将登陆天津，在津湾广场，秉承Darry Ring男人一生仅能定制一枚的坚守，体验古典主义的西式浪漫！ <br /> </span></p> 
         <p></p> 
        </div> 
       </div> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-top"> 
         <div class="newesthing_cort-activities-tittle fl"> 
          <p> <strong>Darry Ring昆明店即将开业</strong> <em>(进行中）</em></p> 
          <p> <span>活动时间：</span> <i>2015/5/11 0:00:00</i> <span class="line-padd">-</span> <i>2015/6/10 0:00:00</i> </p> 
         </div> 
         <div class="newesthing_cort-activities-tittle atittle-right fr"> 
          <p> <i>6517</i> <span>人参与了此项活动!</span> </p> 
         </div> 
        </div> 
        <!--标题end--> 
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.html/kmstore"><img width="1000" height="330" src="{{url('libs/home')}}/images/20150513103613f1bbb67d84.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p>
         <p> <span style="color: rgb(136, 136, 136); font-size: 12px;">Darry Ring即将登陆昆明，在春城万达广场，秉承Darry Ring男人一生仅能定制一枚的坚守，爱你不分四季！ <br /> </span></p> 
         <p></p> 
        </div> 
       </div> 
      </div> 
      <div style="display:none" id="div_ing"> 
      </div> 
      <div style="display:none" id="div_over"> 
      </div> 
      <!--各种活动end--> 
      <div class="paging_all" id="pageing_pagingDiv"> 
       <div class="paging_all-cort"> 
        ...
        <p class="pag_p fl"> <span>共4页，到第</span> <input type="text" class="pag_txt" id="pageing_pag_txt" name="pageing$pag_txt" />页 <input type="button" class="pag_bt" onClick="__CurrentPaging.PageIndexChaned($('#pageing_pag_txt').val());$('#pageing_pag_txt').val('');" value="确定" /> </p> 
       </div> 
      </div> 
      <!--分页end--> 
      <!--分页end--> 
   ...
   <div style="display:none;" class="modelsever" id="modelsever"> 
    ...
    <div class="cs_content clear"> 
     ...
     <div id="box1" class="box1"> 
      <div onClick="contenttxt(1,1)" id="content_title_11" class="content_title"></div> 
      <div id="content_title1_1" class="content_txt"></div> 
      <div onClick="contenttxt(1,2)" id="content_title_12" class="content_title"></div> 
      <div id="content_title1_2" class="content_txt"> 
      </div> 
      <div onClick="contenttxt(1,3)" id="content_title_13" class="content_title"></div> 
      <div id="content_title1_3" class="content_txt"> 
      </div> 
      <div onClick="contenttxt(1,4)" id="content_title_14" class="content_title"></div> 
      <div id="content_title1_4" class="content_txt"> 
      </div> 
      <div onClick="contenttxt(1,5)" id="content_title_15" class="content_title"></div> 
      <div id="content_title1_5" class="content_txt"> 
      </div> 
      <div onClick="contenttxt(1,6)" id="content_title_16" class="content_title"></div> 

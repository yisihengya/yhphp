<html xmlns="http://www.w3.org/1999/xhtml" class="hb-loaded">
 ...
 <body>
  ...
  <title>品牌文化</title> 
  <link href="{{asset('libs/home')}}/css/same.css?v=1.3.7.2" type="text/css" rel="stylesheet" />
  <link href="{{asset('libs/home')}}/css/dr_culture.css?v=1.3.5.0" type="text/css" rel="stylesheet" />
  <form id="aspnetForm" action="brand.html" method="post" name="aspnetForm">
   <div> 
    <!--头部-->
     ...
     <div class="cort"> 
      ...
      <div class="cmain culture_same"> 
       ...
       <div class="zbk_top spalid">
        <div class="zbk_top spalid">
         <span>您当前的位置：</span> 
         <span id="ctl00_content_website_SiteMapPath1"><a href="#ctl00_content_website_SiteMapPath1_SkipLink"></a><span> <a target="_blank" href="{{url('index')}}">Darry Ring</a> </span><span> <em>&gt;</em> </span><span> <span>品牌文化</span> </span><a id="ctl00_content_website_SiteMapPath1_SkipLink"></a></span>
        </div> 
       </div> 
       <!--面包屑end--> 
       <!--标题--> 
       ...
       <div class="culture_nav"> 
        ...
        <i>|</i> 
        <a href="brand.html_br">品牌理念</a> 
        <i>|</i> 
        <a target="_blank" href="brand.html_mr">名人推荐</a> 
        <i>|</i> 
        <a target="_blank" href="/shopyd">实体店</a> 
        <i>|</i> 
        <a href="brand.html_pz">品质工艺</a> 
        <i>|</i> 
        <a href="brand.html_tl">真爱验证</a> 
        <i>|</i> 
        <a target="_blank" href="http://bbs.darryring.com/">DR社区</a> 
        <i>|</i> 
        <a href="brand.html_jo">加入我们</a> 
        <i>|</i> 
        <a target="_blank" href="/heizuan">黑钻专题</a> 
       </div> 
       <!--导航end--> 
       <!--特殊颜色的P--> 
       ...
       <div class="culture_pp culture_first"> 
        <!--左边--> 
        <div class="fl"> 
         <a target="_blank" href="/dr_brand.aspx"> <img width="470" height="300" src="{{url('libs/home')}}/images/wh1.jpg" /> </a>
        </div> 
        <!--左边end--> 
        <!--右边--> 
        <div class="culture_pp-word fr"> 
         ...
         <a class="to_more" target="_blank" href="brand.html_br">了解更多</a> 
        </div> 
        <!--右边end--> 
       </div> 
       <!--品牌理念end--> 
       <!--三大块--> 
       <div class="three_yz"> 
        <a href="index.htmlbrand.html_tl" target="_blank"> <img width="300" height="426" src="{{url('libs/home')}}/images/re1.jpg" /> </a>
        <a href="index.htmlbrand.html_pr" target="_blank"> <img width="300" height="426" src="{{url('libs/home')}}/images/re2.jpg" /> </a>
        <a href="index.htmlbrand.html_zo" target="_blank"> <img width="300" height="426" src="{{url('libs/home')}}/images/re3.jpg" /> </a>
       </div> 
       <!--三大块end--> 
       <!--社会名人--> 
       <div class="culture_pp culture_sec"> 
        ...
        <div class="culture_pp-word fl"> 
         ...
         <a class="to_more" target="_blank" href="brand.html_mr">了解更多</a> 
        </div> 
        <!--左边end--> 
        <!--右边--> 
        <div class="culture_sec-right fr"> 
         <a target="_blank" href="dr_mrtj.aspx"> <img width="367" height="250" src="{{url('libs/home')}}/images/wh2.jpg" /> </a>
        </div> 
        <!--右边end--> 
       </div> 
       <!--社会名人end--> 
       ...
       <div class="culture_pp culture_thrid"> 
        ...
        <div class="culture_thrid-left fl"> 
         <a target="_blank" href="/shopyd"> <img width="367" height="230" src="{{url('libs/home')}}/images/wh3.jpg" /> </a>
        </div> 
        <!--左边end--> 
        <!--右边--> 
        <div class="culture_pp-word fr"> 
         ...
         <a class="to_more" target="_blank" href="/shopyd">了解更多</a> 
        </div> 
        <!--右边end--> 
       </div> 
       <!--最烂漫的珠宝店end--> 
       ...
       <div class="culture_pp"> 
        ...
        <div class="culture_four-left fl"> 
         <img width="465" height="300" src="{{url('libs/home')}}/images/wh4.jpg" />
         <!--透明背景--> 
         ...
         <div class="professional_gy"> 
          ...
          <a class="to_more" target="_blank" href="brand.html_pz">了解更多</a> 
         </div> 
         <!--工艺end--> 
        </div> 
        <!--品质工艺end--> 
        ...
        <div class="culture_four-right fr"> 
         <img width="465" height="300" src="{{url('libs/home')}}/images/wh5.jpg" />
         <!--DR族--> 
         <div class="brand_drz"> 
          <h3> 真爱验证</h3> 
          <h4> Brand Culture</h4> 
          <p> 男士一生仅能定制一枚，</p> 
          <p> 赠予此生唯一挚爱的女子</p> 
          <a class="to_more" target="_blank" href="/dryz">了解更多</a> 
         </div> 
         <!--DR族end--> 
        </div> 
        <!--DR族end--> 
       ...
       <div class="culture_pp"> 
        ...
        <div class="culture_last fl"> 
         <a target="_blank" href="http://bbs.darryring.com"> <img width="465" height="200" src="{{url('libs/home')}}/images/wh6.jpg" /> </a>
        </div> 
        <!--左边end--> 
        <!--右边--> 
        <div class="culture_last fr"> 
         <a target="_blank" href="brand.html_jo"> <img width="466" height="200" src="{{url('libs/home')}}/images/wh7.jpg" /> </a>
        </div> 
        <!--右边end--> 
       </div> 
       <!--DR社区与加入我们end--> 

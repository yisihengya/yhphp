    ...
    function toPay() {
      ...
      <div class="shop_cort-left fl"> 
       ...
       <table cellspacing="0" cellpadding="0" border="0" class="shop_tabble"> 
        <tbody>
         ...
         <tr class="cp_tr"> 
          <td class="sp_td"> <a href="/darry_ring/87.html" class="jx_shop"> <img width="85" height="85" src="{{url('libs/home')}}/images/201409011932585de1c2f2a9.jpg" /> <span> Forever系列 经典款</span></a> </td>
       ...
       <!--结算--> 
       <div class="shop_js"> 
        <a class="jx_shop" href="{{url('home/lists')}}l">继续购物</a>
        ...
        <span onClick="toPay();" class="end_bt"><em><a href="{{asset('home/cart_agreement')}}">立即结算</a></em></span>
       </div> 
       <!--结算end--> 
      </div> 
      <!--左边end--> 
     ...
     <div class="cmain shop_foot"> 
      ...
      <div class="shop_foot-img"> 
       <img src="{{url('libs/home')}}/images/db.jpg" />
      </div> 
     </div> 
     <!--底部end--> 
    </div> 

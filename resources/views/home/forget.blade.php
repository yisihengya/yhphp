<html class="hb-loaded">
 ...
 <body>
  <script src="{{asset('libs/home/js/jquery-1.10.1.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('libs/home/js/common.js')}}" type="text/javascript"></script>
   ...
   <div class="head_top"> 
    <div class="head clearfix"> 
     ...
     <div class="topLeft left">
      <a href="{{asset('home/index')}}" title="Darry Ring"> <img width="186" height="42" src="{{url('libs/home/images/logo_01.png')}} " /> </a>
      <span>求婚钻戒领导品牌</span> 
     </div> 
     <!--头部左边end--> 
     <!--头部右边--> 
     ...
     <div class="cmain ddd">
      ...
      <div class="cort-right right"> 
       ...
       <div class="cr_border"> 
        ...
        <!--手机注册--> 
        <form method="post" action="{{asset('home/forget')}}" class="form_first">
        ...
        <!--手机注册end--> 
        <!--邮箱注册--> 
        <form method="post" action="{{asset('home/forget')}}" class="form_second">
         ...
         <div style="display:none" class="photo_show"> 
          ...
          <div style="border:none" class="the_input"> 
           ...
           <div class="action_code">
            <a title="点击刷新验证码" href="javascript:void(0)"><img onClick="javascript:this.src = '/code?' + Math.random();" src="{{asset('libs/home/images/code')}}" /></a>
           </div> 
          </div> 
          <!--验证码end--> 
          <div style="display:none" class="other_input"> 
          ...
          <div class="email_send"> 
           <img src="{{url('libs/home/images/right.gif')}}" />
           <span style="color:red">&nbsp;&nbsp;邮件发送成功 </span>

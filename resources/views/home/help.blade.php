<html xmlns="http://www.w3.org/1999/xhtml" class="hb-loaded">
 <head>
  <link href="{{'libs/home'}}/css/same.css?v=1.3.7.2" type="text/css" rel="stylesheet" />
 </head>
 <body>
  ...
  <link href="{{asset('libs/home')}}/css/aboutUs.css?v=1.3.5.0" type="text/css" rel="stylesheet" />
  <script src="{{asset('libs/home')}}/js/aboutUs.js" type="text/javascript"></script>
  <title>
	注册协议_Darry Ring求婚钻戒价格 戴瑞珠宝官网
</title>
    ...
    <div class="cmain"> 
     <div class="headtop"> 
      ...
      <div class="top-left fl"> 
       <a title="Darry Ring" href="index.html"> <img width="187" height="42" alt="Darry Ring官网" src="{{asset('libs/home')}}/images/logo.png" /> </a>
      ...
      <div class="top-right fr"> 
       ...
       <ul class="tright-ul fl"> 
        <div id="ctl00_ucheader_pllogin1"> 
         <li><a rel="nofollow" href="{{asset('home/login')}}">登录</a><em>|</em></li>
         <li><a rel="nofollow" href="{{asset('home/reg')}}">注册</a></li>
         <li class="headed"><em class="icon shooping"></em><a target="black" rel="nofollow" href="{{asset('home/cart')}}">购物车</a><i>(0)</i></li>
        </div> 
       </ul> 
       <!--语言选择--> 
       <ul class="langruge-ul fr"> 
        <li><a target="_blank" href="{{asset('home/index')}}">English</a></li>
       </ul> 
       <!--搜索框--> 
      ...
      <div class="cmain aboutUs"> 
       ...
       <div class="about_center"> 
        ...
        <ul class="abc_left fl"> 
         <li> <h3> <a href="/help_ab.html">-关于我们-</a></h3> </li> 
         <li> <h3> <a href="help.html">-帮助中心-</a></h3> </li> 
         <li> <h3> -服务条款-</h3> 
          <!--里面的ul--> 
          <ul class="abul_ul"> 
           <li class="bau_other"> <h4> <a id="79" href="/help_se/79.html"> 修改手寸 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="80" href="/help_se/80.html"> 终生保养 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="81" href="/help_se/81.html"> 一钻双证 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="82" href="/help_se/82.html"> 钻石更换 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="83" href="/help_se/83.html"> 全程保险 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="84" href="/help_se/84.html"> 15天退换 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="85" href="/help_se/85.html"> 注册协议 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="86" href="/help_se/86.html"> 隐私声明 </a> </h4> </li> 
          </ul> 
          <!--里面的ul end--> </li> 
        </ul> 
        <!--左边end--> 

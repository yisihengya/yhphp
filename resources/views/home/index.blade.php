...
<head>
 <title>首页</title>
 <link href="{{asset('libs/home')}}/css/index_A.css?v=1.3.7.1" type="text/css" rel="stylesheet" />
 <link href="{{asset('libs/home')}}/css/same_A.css?v=1.3.7.2" type="text/css" rel="stylesheet" />
 ...
 <div>
   ...
   <ul class="indexbanner">
    <li class="tb_first" style="display: block; opacity: 0.982279;">
     <div class="cmain cb_main">
      ...
      <div class="banner-word sp_width">
       <img src="{{asset('libs/home')}}/images/dr_logo.png" />
    ...
    <li class="tb_four" style="display: none;">
     <div class="cmain cb_main">
      ...
      <div class="banner-word sp_width">
       <img src="{{asset('libs/home')}}/images/spdr_logo.png" />
  ...
  <div class="all-thing">
   ...
   <div class="cmain">
    <!--验证身份-->
    <div class="love_doit">
     <div class="loverit_center">
      <div class="loverit_write">
       <label>国家/区域:</label>
       ...
       <label>先生姓名:</label>
       <input type="text" class="lit_txt" id="textName" />
       <label>身份证号码:</label>
       <input type="text" class="lit_txt" id="textIDCard" />
    ...
    <ul class="news-ul">
     ...
     <li>
      <div class="ul-top">
       <a target="_blank" href="/shopyd"> <img width="235" height="130" alt="Darry Ring实体店" src="{{asset('libs/home')}}/images/tyzx.jpg" /> </a>
      </div>
      <div class="ul-center">
     ...
     <li>
      <div class="ul-top">
       <a target="_blank" href="brand.html"> <img width="235" height="130" alt="关于Darry Ring" src="{{asset('libs/home')}}/images/zajz.jpg" /> </a>
      </div>
      <div class="ul-center">
     ...
     <li>
      <div class="ul-top">
       <a target="_blank" href="brand.html_mr"> <img width="235" height="130" alt="社会名人倾情推荐" src="{{asset('libs/home')}}/images/famous.jpg" /> </a>
      </div>
      <div class="ul-center">
     ...
     <li>
      <div class="ul-top">
       <a target="_blank" href="lists.html"> <img width="235" height="130" alt="网络热门钻戒品牌" src="{{asset('libs/home')}}/images/wlzj.jpg" /> </a>
      </div>
      <div class="ul-center">
    ...
    <ul class="all_tab">
     <li style="display: none;">
      ...
      <div class="tab_left fl">
       <a href="index.html/dr_series/12_22.html"> <img width="504" height="314" alt="Forever经典系列" src="{{asset('libs/home')}}/images/fimg6.jpg" /> </a>
      </div>
      <!--tab选项卡下的左边内容 end-->
      <!--tab选项卡下的右边内容-->
     ...
     <li style="display: none;">
      <!--tab选项卡下的左边内容-->
      <div class="tab_left fl">
       <a href="/pinkdiamond.aspx"> <img width="504" height="314" alt="Marry Me系列" src="{{asset('libs/home')}}/images/fimg1.jpg" /> </a>
      </div>
      <!--tab选项卡下的左边内容 end-->
      <!--tab选项卡下的右边内容-->
      <div class="tab_right fr">
     ...
     <li style="display: none;">
      <!--tab选项卡下的左边内容-->
      <div class="tab_left fl">
       <a href="/dr_series/11_20.html"> <img width="504" height="314" alt="My heart系列" src="images/fimg2.jpg" /> </a>
      </div>
      <!--tab选项卡下的左边内容 end-->
      <!--tab选项卡下的右边内容-->
      <div class="tab_right fr">
     ...
     <li style="display: list-item; opacity: 0.470565;">
      <!--tab选项卡下的左边内容-->
      <div class="tab_left fl">
       <a href="/dr_series/16_30.html"> <img width="515" height="314" alt="True Love系列" src="{{asset('libs/home')}}/images/fimg3.jpg" /> </a>
      </div>
      <!--tab选项卡下的左边内容 end-->
      <!--tab选项卡下的右边内容-->
      <div class="tab_right fr">
     ...
     <li style="opacity: 0.529435; display: list-item;">
      <!--tab选项卡下的左边内容-->
      <div class="tab_left fl">
       <a href="/dr_series/15_18.html"> <img width="504" height="314" alt="I Swear系列" src="{{asset('libs/home')}}/images/fimg4.jpg" /> </a>
      </div>
      <!--tab选项卡下的左边内容 end-->
      <!--tab选项卡下的右边内容-->
      <div class="tab_right fr">
     ...
     <ul id="ullist" class="buyit">
      <li>
       <div class="by_top">
        ...
        <div style="opacity:1" class="bything-one">
         <img width="236px" height="236px" alt="Forever系列 经典款&nbsp;50分&nbsp;H色" src="{{asset('libs/home')}}/images/2014090119350717386d7a1e.jpg" />
        </div>
        <div style="opacity:0" class="bything-two">
         <img width="236px" height="236px" src="{{asset('libs/home')}}/images/201409011935072849fe802f.jpg" />
        </div>
       </div>
      ...
      <li>
       <div class="by_top">
        <a target="_blank" href="detail.html" rel="nofollow"></a>
        <div style="opacity:1" class="bything-one">
         <img width="236px" height="236px" alt="Forever系列 经典款&nbsp;40分&nbsp;D色" src="{{asset('libs/home')}}/images/201409011932585de1c2f2a9.jpg" />
        </div>
        <div style="opacity:0" class="bything-two">
         <img width="236px" height="236px" src="{{asset('libs/home')}}/images/20140901193258beafcb5eb7.jpg" />
        </div>
       </div>
       <div class="by_center"></div>
       <div class="by_bottom">
      ...
      <li>
       <div class="by_top">
        <a target="_blank" href="detail.html" rel="nofollow"></a>
        <div style="opacity:1" class="bything-one">
         <img width="236px" height="236px" alt="True Love系列 简奢款&nbsp;30分&nbsp;E色" src="{{asset('libs/home')}}/images/2014091515351160b3d26880.jpg" />
        </div>
        <div style="opacity:0" class="bything-two">
         <img width="236px" height="236px" src="{{asset('libs/home')}}/images/20140901162336bad2605031.jpg" />
        </div>
       </div>
       <div class="by_center"></div>
       <div class="by_bottom">
      ...
      <li>
       <div class="by_top">
        <a target="_blank" href="detail.html" rel="nofollow"></a>
        <div style="opacity:1" class="bything-one">
         <img width="236px" height="236px" alt="True Love系列 典雅&nbsp;40分&nbsp;F色" src="{{asset('libs/home')}}/images/201412081512070b82d519cb.jpg" />
        </div>
        <div style="opacity:0" class="bything-two">
         <img width="236px" height="236px" src="{{asset('libs/home')}}/images/20141208151207e3fa9cdc9e.jpg" />
        </div>
       </div>
       <div class="by_center"></div>
       <div class="by_bottom">
     ...
     <div class="bkbook_left-first">
      ...
      <div class="bkleft_img fl">
       <ul class="bkleft_banner">
        <li style="display: block;"><a target="_blank" href="/news/4827.html"> <img width="280px" height="180px" alt="小时代4剧情揭秘，杨幂戴DR真爱戒指或唯一存活" src="{{asset('libs/home')}}/images/20150707185244af94e583ea.jpg" /> </a>
         <!--提示文字-->
         <div class="bnhide">
          <!--透明块-->
         ...
         <!--提示文字end--> </li>
        <li style="display: none;"><a target="_blank" href="/news/4825.html"> <img width="280px" height="180px" alt="最浪漫珠宝店Darry Ring7月7日登陆宁波" src="{{asset('libs/home')}}/images/20150707184746fa95671549.jpg" /> </a>
         <!--提示文字-->
         <div class="bnhide">
          <!--透明块-->
          <div class="banner_opa">
         ...
         <!--提示文字end--> </li>
        <li style="display: none;"><a target="_blank" href="/news/4316.html"> <img width="280px" height="180px" alt="戴瑞戒指价格知多少 价值连城的一生承诺" src="{{asset('libs/home')}}/images/20150707184853bf1307dd75.jpg" /> </a>
         <!--提示文字-->
         <div class="bnhide">
          <!--透明块-->
          <div class="banner_opa">
    ...
    <div class="bkbook_right fr">
     ...
     <div class="bkbook_right-allul">
      ...
      <div class="bkbook_right-fimg fl">
       <a target="_blank" href="/news/4293.html"> <img width="120" height="72" alt="网上买dr钻戒可不可靠" src="{{asset('libs/home')}}/images/20150527154522510535113e.jpg" /> </a>
      </div>
      <!--左边图片end-->
      <!--右边ul-->
     ...
     <div class="bkbook_right-allul">
      <!--左边图片-->
      <div class="bkbook_right-fimg fl">
       <a target="_blank" href="/news/3870.html"> <img width="120" height="72" alt="一克拉钻戒保值" src="{{asset('libs/home')}}/images/2015042918212650e2902a39.jpg" /> </a>
      </div>
      <!--左边图片end-->
      <!--右边ul-->
      <ul class="bkbook_left-secul bkbook_right-spcul">
     ...
     <div class="bkbook_right-allul">
      <!--左边图片-->
      <div class="bkbook_right-fimg fl">
       <a target="_blank" href="/news/4547.html"> <img width="120" height="72" alt="陆烧林萧求婚戒指是什么" src="{{asset('libs/home')}}/images/2015061813430589cb642ca7.jpg" /> </a>
      </div>
      <!--左边图片end-->
      <!--右边ul-->
      <ul class="bkbook_left-secul bkbook_right-spcul">

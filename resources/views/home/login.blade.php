 ...
 <body>
  ...
  <div class="wrap">
   ...
   <div class="head_top">
    <div class="head clearfix">
     ...
     <div class="topLeft left">
      <a href="{{asset('home/index')}}" title="Darry Ring"> <img width="186" height="42" src="{{asset('libs/home/images/logo_01.png')}} " /> </a>
      <span>求婚钻戒领导品牌</span>
     </div>
     <!--头部左边end-->
     <!--头部右边-->
      ...
      <form method="post" action="" id="loginform">
       ...
       <div class="cr_border">
        ...
        <div class="other_input">
         ...
         <div class="right">
          <a href="{{asset('home/forget')}}" class="forget">忘记密码</a>
         </div>
        </div>
        <!--其他选项end-->
        <!--按钮-->
        <div class="other_input">
         <div class="bt1 clearfix" id="login">
          ...
          <input type="submit" value="登陆" class="right focus" id="sub">
         </div>
        </div>
        <!--按钮end-->
        <!--其他合作-->
   ...
   <div class="cmain bc_yz">
    <div class="db_cort">
     <p>Copyright &copy; 2006-2022 www.darryring.com 戴瑞珠宝 All Rights Reserved. 粤ICP备11012085号</p>

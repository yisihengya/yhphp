<html xmlns="http://www.w3.org/1999/xhtml" class="hb-loaded">
 <head>
  ...
  <link href="{{asset('libs.home')}}/css/member.css?v=1.3.6.0" type="text/css" rel="stylesheet" />
  <script type="text/javascript" src="{{asset('libs.home')}}/js/member.js"></script>
  <link type="text/css" rel="stylesheet" href="{{asset('libs.home')}}/css/uploadify.css" />
  <script type="text/javascript" src="{{asset('libs.home')}}/js/jquery.uploadify.js"></script>
  <script type="text/javascript" src="{{asset('libs.home')}}/js/jquery.Jcrop.js"></script>
  <script type="text/javascript" src="{{asset('libs.home')}}/js/Jcrop_photo.js"></script>
 ...
 @section('content')
        ...
        <div class="member_cort"> 
         <div class="member_cort-left fl"> 
          ...
          <div class="member_cortleft-tittle"> 
           <i class="mb_home"></i>
           <a rel="nofollow" href="{{asset('libs.home')}}/member_index.html">我的DR</a>
          </div> 
          <!--我的DR end--> 
          <ul class="member_cort-ul"> 
           <li> <h3> -订单中心-</h3> 
            <ul class="member_ul-dr"> 
             <li id="ctl00_content_ucmemberleft_order"><a rel="nofollow" href="{{asset('libs.home')}}/member_order.html">我的订单</a></li>
             <li id="ctl00_content_ucmemberleft_ask"><a rel="nofollow" href="{{asset('libs.home')}}/member/myevaluate.html">我要评价</a></li>
             <li id="ctl00_content_ucmemberleft_cart"><a rel="nofollow" href="{{asset('libs.home')}}/cart.html" target="_blank">我的购物车</a></li>
             <li id="ctl00_content_ucmemberleft_collect"><a rel="nofollow" href="{{asset('libs.home')}}/member_collect.html">我的收藏</a></li>
             <li class="no_border" id="ctl00_content_ucmemberleft_yuyue"><a rel="nofollow" href="{{asset('libs.home')}}/member/myappointment.html">我的预约</a></li>
            </ul> </li> 
           <li> <h3> -售后服务-</h3> 
            <ul class="member_ul-dr"> 
             <li id="ctl00_content_ucmemberleft_salAfter"><a rel="nofollow" href="{{asset('libs.home')}}/member/aftersale.html">售后办理</a></li>
            </ul> </li> 
           <li> <h3> -帐户管理-</h3> 
            <ul class="member_ul-dr"> 
             <li id="ctl00_content_ucmemberleft_myinfo"><a rel="nofollow" href="{{asset('libs.home')}}/member_info.html">个人信息</a></li>
             <li id="ctl00_content_ucmemberleft_password"><a rel="nofollow" href="{{asset('libs.home')}}/member_pwd.html">修改密码</a></li>
             <li id="ctl00_content_ucmemberleft_address"><a rel="nofollow" href="{{asset('libs.home')}}/member_addr.html">收货地址</a></li>
             <li id="ctl00_content_ucmemberleft_li_jnr"><a href="{{asset('libs.home')}}/member/mydr_jnr.html">纪念日维护</a></li>
             <li id="ctl00_content_ucmemberleft_zhuanshu"> <a href="{{asset('libs.home')}}/member/DarryHome.aspx"> 专属空间</a></li>
             <li class="no_border" id="ctl00_content_ucmemberleft_news"><a rel="nofollow" href="{{asset('libs.home')}}/member/mynews.html">系统消息</a></li>
            </ul> </li> 
          </ul> 
         </div> 
         <!--右边的主要内容--> 
         <div class="member_cort-right fr"> 
          ...
          <div class="member_person"> 
           ...
           <div class="member_person-upload"> 
            <img id="bPic" style="width: 300px; height: 300px; display: none;" src="{{asset('libs.home')}}/images/mem-big.jpg" />
            <div style="width: 300px; height: 300px; position: relative; background-color: rgb(205, 205, 205);" class="jcrop-holder">
             <div style="position: absolute; z-index: 300; width: 90px; height: 90px; top: 10px; left: 10px;">
              <div style="width: 100%; height: 100%; z-index: 310; position: absolute; overflow: hidden;">
               <img src="{{asset('libs.home')}}/images/mem-big.jpg" style="position: absolute; width: 300px; height: 300px; top: -10px; left: -10px;" />
             ...
             <img style="width: 300px; height: 300px; position: absolute; opacity: 0.5;" src="{{asset('libs.home')}}/images/mem-big.jpg" />
            </div> 
            <div id="preview_box" class="person-upload-right"> 
             <img id="crop_preview" src="{{asset('libs.home')}}/images/mem-big.jpg" style="width: 300px; height: 300px; margin-left: -10px; margin-top: -10px;" />
            </div> 
      ...
      <ul class="Service_ul"> 
       ...
       <li> 
        <div class="Service_ul-img"> 
         <a href="{{asset('libs.home')}}/index.html/help_ab/51.html" rel="nofollow"></a>
        </div> <a href="{{asset('libs.home')}}/index.html/help_ab/51.html" rel="nofollow"><p>权威认证</p></a> </li>
       <!--每一块li--> 
       <li> 
        <div class="Service_ul-img bk_2"> 
         <a href="{{asset('libs.home')}}/index.html/help_se/81.html" rel="nofollow"></a>
        </div> <a href="{{asset('libs.home')}}/index.html/help_se/81.html" rel="nofollow"><p> 一钻双证</p></a> </li>
       <!--每一块li--> 
       <li> 
        <div class="Service_ul-img bk_3"> 
         <a href="{{asset('libs.home')}}/index.html/help_se/80.html" rel="nofollow"></a>
        </div> <a href="{{asset('libs.home')}}/index.html/help_se/80.html" rel="nofollow"> <p> 终生保养</p></a> </li>
       <!--每一块li--> 
       <li> 
        <div class="Service_ul-img bk_4"> 
         <a href="{{asset('libs.home')}}/index.html/help_se/82.html" rel="nofollow"></a>
        </div> <a href="{{asset('libs.home')}}/index.html/help_se/82.html" rel="nofollow"> <p> 以小换大</p></a> </li>
       <!--每一块li--> 
       <li> 
        <div class="Service_ul-img bk_5"> 
         <a href="{{asset('libs.home')}}/index.html/help_se/84.html" rel="nofollow"></a>
        </div> <a href="{{asset('libs.home')}}/index.html/help_se/84.html" rel="nofollow"> <p> 15天退换</p></a> </li>
       <!--每一块li--> 
       <li> 
        <div class="Service_ul-img bk_6"> 
         <a href="{{asset('libs.home')}}/index.html/help/74.html" rel="nofollow"></a>
        </div> <a href="{{asset('libs.home')}}/index.html/help/74.html" rel="nofollow"> <p> 全国免运费</p></a> </li>
       <!--每一块li--> 
       <li> 
        <div class="Service_ul-img bk_7"> 
         <a href="{{asset('libs.home')}}/index.html/help_se/83.html" rel="nofollow"></a>
        </div> <a href="{{asset('libs.home')}}/index.html/help_se/83.html" rel="nofollow"><p> 全程保险</p></a> </li>
      </ul> 
      <!--服务条款--> 
      <div class="service"> 
       <!--二维码--> 
       <div class="erwei fl"> 
        <img width="90" height="90" alt="Darry Ring 官方微信" src="{{asset('libs.home')}}/images/erwei.jpg" />
       </div> 
       <!--中间的联系方式--> 
       <div class="know_right fl"> 
        <p> 24小时全国免费服务热线</p> 
        <img width="171" height="32" src="{{asset('libs.home')}}/images/tel.jpg" />
       ...
       <ul class="Service_know fr"> 
        <!--每一块li--> 
        <li> <h3> 关于我们</h3> <p> <a target="_blank" href="{{asset('libs.home')}}/index.html/help_ab/66.html" rel="nofollow">权威认证</a></p> <p> <a target="_blank" href="index.html/help_ab/68.html" rel="nofollow">商务合作</a></p> <p> <a target="_blank" href="index.html/help_ab/70.html" rel="nofollow">加入我们</a></p> </li>
        <!--每一块li--> 
        <li> <h3> 关于购买</h3> <p> <a target="_blank" href="{{asset('libs.home')}}/index.html/help/72.html" rel="nofollow">购买流程</a></p> <p> <a target="_blank" href="index.html/help/73.html" rel="nofollow">支付方式</a></p> <p> <a target="_blank" href="index.html/help/74.html" rel="nofollow">配送流程</a></p> </li>
        <!--每一块li--> 
        <li> <h3> 关于退换</h3> <p> <a target="_blank" href="{{asset('libs.home')}}/index.html/help/75.html" rel="nofollow">退货流程</a></p> <p> <a target="_blank" href="index.html/help/76.html" rel="nofollow">办理售后</a></p> <p> <a target="_blank" href="index.html/help_se/84.html" rel="nofollow">15天退换</a></p> </li>
        <!--每一块li--> 
        <li> <h3> 帮助中心</h3> <p> <a target="_blank" href="{{asset('libs.home')}}/index.html/help/71.html" rel="nofollow">注册流程</a></p> <p> <a href="javascript:showxiaon();" rel="nofollow">联系客服</a></p> <p> <a target="_blank" href="index.html/help/78.html" rel="nofollow">网站地图</a></p> </li>
        <!--每一块li--> 
        <li> <h3> 服务条款</h3> <p> <a target="_blank" href="{{asset('libs.home')}}/index.html/help_se/80.html" rel="nofollow">终生保养</a></p> <p> <a target="_blank" href="index.html/help_se/85.html" rel="nofollow">注册协议</a></p> <p> <a target="_blank" href="index.html/help_se/86.html" rel="nofollow">隐私声明</a></p> </li>
        <!--每一块li--> 
        <li> <h3> DR服务</h3> <p> <a target="_blank" href="{{asset('libs.home')}}/proposelist.aspx?id=18">钻石百科</a></p> <p> <a target="_blank" href="/news/index.aspx">产品百科</a></p> <p> <a target="_blank" href="/propose.aspx">求婚指南</a></p> </li>
       </ul> 
      </div> 
      <!--条文--> 
    ...
    <div style="display:none" class="Ffloat_kf"> 
     <div class="fkf_top"> 
      ...
      <div id="bdBridge"> 
       <a href="javascript:NTKF.im_openInPageChat()"> <img width="75" height="37" src="{{asset('libs.home')}}/images/zx.jpg" /></a>
      </div> 
     </div> 
     <div class="fkf_bottom"> 
      <img width="92" height="82" alt="Darry Ring 官方微信" src="{{asset('libs.home')}}/images/to_erwei.jpg" />
      <a href="#"> <img width="92" height="26" src="{{asset('libs.home')}}/images/db.jpg" /></a>
     </div> 
    </div> 
    <!--新版右边客服start--> 
    <!--右边漂浮悬挂大的--> 
    <div class="float_big"> 
     ...
     <div class="floatbig_center"> 
      ...
      <!--定制咨询end--> 
      <img src="{{asset('libs.home')}}/images/ew.jpg" />
     </div> 
    </div> 
    <!--右边漂浮悬挂大的end--> 
    <!--右边漂浮悬挂小的--> 
    ...
    <div style="position: fixed; cursor: pointer; right: 6px; top: 289px; padding-bottom: 152px; z-index: 9999; width: 19px; height: 103px; display: none;" onClick="openserver();" id="openbnt"> 
     <img width="19" height="103" src="{{asset('libs.home')}}/images/server_03.jpg" />
    </div> 
    <div class="news_tc"> 
     ...
     <div class="cs_top"> 
      <div class="cs_topcenter">
       ...
       <div style="width:385px; height:20px; float:left; text-align:right; padding-top:20px;"> 
        <img width="55" height="9" style="cursor: pointer;" onClick="CloseMaskser()" src="{{asset('libs.home')}}/images/popup_window_btn_close.gif" />
       </div> 
      </div> 
     </div> 

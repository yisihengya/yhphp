<html xmlns="http://www.w3.org/1999/xhtml" class="hb-loaded"><head><link href="css/same.css?v=1.3.7.2" type="text/css" rel="stylesheet"/>

 <meta charset="utf-8"/>
    <title>个人中心 - 订单详情</title><!--/*技术支持，小庄602842076     验证：官网技术支持*/
    ...
    <ul class="member_cort-ul">
        ...
        <li>
            ...
            <ul class="member_ul-dr">
                ...
                <li id="ctl00_content_ucmemberleft_zhuanshu">
                    ...
                    <div class="member_myorder-xq-news">
                    	<div class="myorder-xq-news_top">
                            ...
                            <div class="member_all-nav-right fr">
                                ...
                                <a style="cursor: pointer" onClick="javascript:showxiaon();">在线客服>></a>
                            </div>
                        </div>
                        <!--订单信息的table-->
                        <table cellspacing="0" cellpadding="0" border="0" class="myorder-xq-news_table" style="font-family:微软雅黑">
                        	<tbody><tr>
                                ...
                                <td class="news_table-td1">预计到货日期</td>
                            ...
                            <tr>
                                ...
                                <td class="news_table-td1">联系电话</td>
                                <td class="news_table-td3"></td>
                            </tr>
                            <tr>
                            	<td class="news_table-td1">E-Mail</td>
                                <td class="news_table-td2"></td>
                                <td class="news_table-td1">收货人地址</td>
                                <td class="news_table-td3">福建省龙岩市长汀县娃娃亲到青岛</td>
                            </tr>
                             <tr>
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" class="myorder-xq-shop_table">
                        	<tbody><tr class="xq-shop_table-trfirst">
                                ...
                                <td class="xq-shop_table-td5">刻 字</td>
                                <td class="xq-shop_table-td6">价 格</td>
                                    ...
                                    <tr class="xq-shop_table-trsec">
                            	        <td class="xq-shop_table-td1">
                                            ...
                                            <img width="55" height="55" class="fl" src="images/201409011932585de1c2f2a9.jpg">
                                            <span class="fl">
                                            Forever系列 经典款
                                            </span></a>
                                        </td>
                                        <td class="xq-shop_table-td2">
                                	        <p>30分 G色</p><p>VS2 EX</p><p></p>
                              	        </td>

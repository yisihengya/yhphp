...
<div class="cmain">
    <div class="headtop">
        ...
        <div class="top-left fl">
            <a title="Darry Ring" href="{{asset('index')}}">
                <img width="187" height="42" alt="Darry Ring官网" src="{{url('libs/home/images/logo.png')}}">
        ...
        <div class="top-right fr">
            ...
            <ul class="langruge-ul fr">
                <li><a target="_blank" href="{{asset('index')}}">English</a></li>
            </ul>
            <!--搜索框-->
                ...
                <div class="nav-div">
                 <div class="navdiv_top">
                    ...
                    <div class="navdiv-left">
                        <h3>
                            NEW</h3>
                        <a href="{{asset('darry/')}}/darry_ring/349.html">
                            <img width="138" height="97" alt="2克拉钻戒价格_E色EX切工VVS2净度_True Love系列 奢华款 _Darry Ring求婚钻戒 戴瑞珠宝官网" src="images/03wj.jpg"></a>
                        <div class="more_cp">
            ...
            <li><a style="font-family:arial" href="lists.html">Darry Ring 爱的礼物</a>
                <div class="nav-div">
                 <div class="navdiv_top">
                    <div class="navdiv-right">
                      <p>
                            <a href="lists.html">查看所有</a></p>
                     <p>
                            <a href="/dr_phonics">对戒</a></p>
                        <p>
                            <a href="/jewelry_2">男戒</a></p>
                        <p>
                            <a href="/jewelry_4">吊坠</a></p>
                        <p>
                            <a href="/jewelry_5">项链</a></p>
                        <p>
                            <a href="/jewelry_8">手链</a></p>
                        <p>
                            <a href="/jewelry_6">耳钉/耳环</a></p>
                       
                    </div>
                    <div class="navdiv-right special_right noborder">
                        <p>
                            <a href="/j_series/22_12.html">Forever系列</a></p>
                        <p>
                            <a href="/j_series/20_11.html">My Heart系列</a></p>
                        <p>
                            <a href="/j_series/24_13.html">Just You系列</a></p>
                        <p>
                            <a href="/j_series/30_16.html">True Love系列</a></p>
                        
                        <p>
                            <a href="/j_series/28_15.html">I Swear系列</a></p>
                        <div class="more_cp">
            ...
            <li class="lipos"><em></em><a href="active.html">最新活动</a> <i class="icon"></i>
                ...
                <div class="navdiv_top">
                    ...
                    <div class="navleft_div fl">
                        <a href="/xiaoshidai4.html">
                            <img width="187" height="163" alt="" src="images/xsdcat.jpg"></a>
                    </div>
                    </div>
                       <div class="navdiv_bottom"></div>
                </div>
    ...
    <div class="cort">
        ...
        <span id="ctl00_content_website_SiteMapPath1"><a href="#ctl00_content_website_SiteMapPath1_SkipLink"></a><span>
            ...
            <em>></em>
                ...
                <a target="_blank" href="member_index.html">我的DR</a>
            </span><span>
            <em>></em>
            </span><span>
            <span>修改密码</span>
...
<div class="member_cort-left fl">
    ...
    <div class="member_cortleft-tittle">
        <i class="mb_home"></i><a rel="nofollow" href="member_index.html">我的DR</a>
    </div>
    <!--我的DR end-->
    <ul class="member_cort-ul">
        ...
        <li>
            ...
            <ul class="member_ul-dr">
                ...
                <li class="speacil_color" id="ctl00_content_treeId_password"><a rel="nofollow" href="member_pwd.html">修改密码</a></li>
                ...
                <li id="ctl00_content_treeId_zhuanshu">
                    <a href="/member/DarryHome.aspx"> 专属空间</a></li>

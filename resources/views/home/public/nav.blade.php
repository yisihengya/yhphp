<div class="nav">
    <div class="cmain">
        ...
        <ul class="nav-ul fl">
            ...
            <li><a href="{{url('home/brand')}}">品牌文化</a> </li>
            <!--
            ...
            <li><a style="font-family:arial" href="{{url('home/lists')}}">Darry Ring 求婚钻戒</a>
                <div class="nav-div">
                    <div class="navdiv_top">
                        ...
                        <div class="navdiv-left">
                            <h3> NEW</h3>
                            <a href="detail.html"> <img width="138" height="97" alt="2克拉钻戒价格_E色EX切工VVS2净度_True Love系列 奢华款 _Darry Ring求婚钻戒 戴瑞珠宝官网" src="{{url('libs/home')}}/images/03wj.jpg" /></a>
                            <div class="more_cp">
            ...
            <li><a style="font-family:arial" href="{{url('home/lists')}}">Darry Ring 爱的礼物</a>
                <div class="nav-div">
                    <div class="navdiv_top">
                        <div class="navdiv-right">
            ...
            <li><a href="{{url('home/question')}}">常见问题</a></li>
        </ul>
        <!--导航的右边-->
        <ul class="nav-right fr">
            <li class="lipos"><em></em><a href="{{url('home/active')}}">最新活动</a> <i class="icon"></i>
                <div class="theright_div">
                    <div class="navdiv_top">
                        ...
                        <div class="navleft_div fl">
                            <a href="/xiaoshidai4.html"> <img width="187" height="163" alt="" src="{{url('libs/home')}}/images/xsdcat.jpg" /></a>
                        </div>
                    </div>
                    <div class="navdiv_bottom"></div>
                </div> </li>

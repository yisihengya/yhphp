<html xmlns="http://www.w3.org/1999/xhtml" class="hb-loaded"><head><link href="{{asset('libs/home')}}/css/same.css?v=1.3.7.2" type="text/css" rel="stylesheet">

<meta content="Darry Ring 钻戒购买常见问题库包含 Darry Ring 钻戒价格和 Darry Ring 实体店地址等， DR 族可以很清晰地在 Darry Ring 常见问题找到大部分问题的答案，如未解决疑问欢迎咨询在线客服。" name="Description">

    <script type="text/javascript" src="{{asset('libs/home')}}/js/jquery.js"></script>
    <script src="{{asset('libs/home')}}/js/index.js?virsion=1.3.7.2" type="text/javascript"></script>
    <script src="{{asset('libs/home')}}/js/aboutUs.js" type="text/javascript"></script>
    <link href="{{asset('libs/home')}}/css/aboutUs.css?v=1.3.5.0" type="text/css" rel="stylesheet"><link href="{{asset('libs/home')}}/css/same.css?v=1.3.7.2" type="text/css" rel="stylesheet">
...
//            $.get("/nAPI/Comment.ashx?action=buyques&id=" + id, function (data) {
//                if (data != "") {
//                    $(".buy_question").html("");
//                    $(".buy_question").html(data);
...
//            });
        ...
        function commaction(id) {

//            $.get("/nAPI/Comment.ashx?action=commonque&type=" + id, function (data) {
//                if (data != "") {
//                    $(".com-question").html("");
//                    $(".com-question").html(data);
//                    if (id == 1) {
//                        $("#commonqudestion").text("官网店铺：");
//                    } else if (id == 2) {
//                        $("#commonqudestion").text("真爱疑问：");
//                    }
//                    else if (id == 3) {
//                        $("#commonqudestion").text("购买限制：");
//                    }
//                    else if (id == 4) {
//                        $("#commonqudestion").text("产品疑问：");
//                    }
//                    else if (id == 5) {
//                        $("#commonqudestion").text("关于定制：");
//                    }
//                    else if (id == 6) {
//                        $("#commonqudestion").text("关于运输：");
//                    }
//                    else if (id == 7) {
//                        $("#commonqudestion").text("关于售后：");
//                    }
//                    /*问题切换*/
//                    $('.com-question li').each(function (index, element) {
//                        $('.com-question h4').eq(index).click(function () {
...
<title>常见问题</title><script type="text/javascript" async="async" charset="utf-8" src="http://trail.ntalker.com:443/trail/trail/userinfo.php?action=save&url=http%3A%2F%2Fwww.darryring.com%2Fdr_question&siteid=kf_9883&uid=kf_9883_ISME9754_guestTEMPAFC8-CAE1-DA&uname=&device=PC&isvip=0&userlevel=&cid=guestTEMPAFC8-CAE1-DA19-81CA-BCEF41931943&sid=1436276993226185&log=0&pageid=1436277340654&update=0&sellerid=&ttl=Darry+Ring+%E9%92%BB%E6%88%92%E8%B4%AD%E4%B9%B0%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98+-Darry+Ring+%E6%88%B4%E7%91%9E%E7%8F%A0%E5%AE%9D%E5%AE%98%E7%BD%91&ref=http%3A%2F%2Fwww.darryring.com%2F"></script><script type="text/javascript" async="async" charset="utf-8" src="http://trail.ntalker.com:443/trail/trail/userinfo.php?action=save&url=http%3A%2F%2Fwww.darryring.com%2Fdr_question&siteid=kf_9883&uid=kf_9883_ISME9754_guestTEMPAFC8-CAE1-DA&uname=&device=PC&isvip=0&userlevel=&cid=guestTEMPAFC8-CAE1-DA19-81CA-BCEF41931943&sid=1436276993226185&log=0&pageid=1436277340664&update=0&sellerid=&ttl=Darry+Ring+%E9%92%BB%E6%88%92%E8%B4%AD%E4%B9%B0%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98+-Darry+Ring+%E6%88%B4%E7%91%9E%E7%8F%A0%E5%AE%9D%E5%AE%98%E7%BD%91&ref=http%3A%2F%2Fwww.darryring.com%2F"></script><script type="text/javascript" async="async" charset="utf-8" src="js/zh_cn.js?siteid=kf_9883" data-requiremodule="lang"></script><script type="text/javascript" async="async" charset="utf-8" src="js/chat.in.js?siteid=kf_9883" data-requiremodule="chatManage"></script><script type="text/javascript" async="async" charset="utf-8" src="js/nt2.js?siteid=kf_9883" data-requiremodule="Window"></script><script type="text/javascript" async="async" charset="utf-8" src="js/zh_cn.js?siteid=kf_9883" data-requiremodule="lang"></script><script type="text/javascript" async="async" charset="utf-8" src="js/chat.in.js?siteid=kf_9883" data-requiremodule="chatManage"></script><script type="text/javascript" async="async" charset="utf-8" src="js/nt2.js?siteid=kf_9883" data-requiremodule="Window"></script></head>
<body><iframe src="javascript:false;" style="display: none;"></iframe>
    <form id="aspnetForm" action="{{url('home/question')}}" method="post" name="aspnetForm">
<div>
<input type="hidden" value="/wEPDwULLTEyNjA4NzU2OTIPZBYCZg9kFgICAxBkZBYEAgEPZBYCAgMPDxYCHgdWaXNpYmxlZ2QWAmYPDxYCHgRUZXh0BQZLTE5nT2tkZAIFD2QWAmYPFgIeC18hSXRlbUNvdW50AgpkZNMC83bARLggNYCtiQwfCPTVt7mr" id="__VIEWSTATE" name="__VIEWSTATE">
</div>

<div>

	<input type="hidden" value="42E97392" id="__VIEWSTATEGENERATOR" name="__VIEWSTATEGENERATOR">
</div>
    <div>
            ...
            <div class="about_center">
                ...
                <div style="display:none" class="about_center-top">
                    ...
                    <ul class="ttop_right fl">
                        <li><span class="tdnav-left"></span><a class="tdnav-center" onClick="buyaction(89)" href="javascript:void(0);">1. 挑选款式</a> </li>
                        <li><span class="tdnav-left"></span><a class="tdnav-center" onClick="buyaction(90)" href="javascript:void(0);">2. 挑选钻石</a> </li>
                        <li><span class="tdnav-left"></span><a class="tdnav-center" onClick="buyaction(91)" href="javascript:void(0)">3. 身份验证</a> </li>
                        <li><span class="tdnav-left"></span><a class="tdnav-center" onClick="buyaction(92)" href="javascript:void(0)">4. 填写协议</a> </li>
                        <li><span class="tdnav-left"></span><a class="tdnav-center" onClick="buyaction(93)" href="javascript:void(0)">5. 提交订单</a> </li>
                ...
                <div class="question_allnav">
                    <ul class="question_allnav-top">
                        <li onClick="buyaction(89)">挑选款式</li>
                        <li onClick="buyaction(90)" class="questionnav-click">挑选钻石</li>
                        <li onClick="buyaction(91)">身份验证</li>
                        <li onClick="buyaction(92)">填写协议</li>
                        <li onClick="buyaction(93)">提交订单</li>
                        <li class="wbs_nobk" onClick="buyaction(94)">完成</li>
                    </ul>
                    <ul class="question_allnav-bottom">
                        <li class=""><span></span></li>
                        <li class="bs_show"><span></span></li>
                        <li><span></span></li>
                        <li><span></span></li>
                        <li><span></span></li>
                        <li><span></span></li>
                ...
                <div class="about_center-cort">
                    ...
                    <ul class="ques_left fl">
                        <li>
                            ...
                            <ul class="ques_ul">
                                <li class="spclick">
                                    <h4 onClick="commaction(1)">
                                        <a href="javascript:void(0);">官网店铺</a>
                                    </h4>
                                </li>
                                <li>
                                    <h4 onClick="commaction(2)">
                                      <a href="javascript:void(0);">真爱疑问</a>
                                    </h4>
                                </li>
                                <li>
                                    <h4 onClick="commaction(3)">
                                        <a href="javascript:void(0);">购买限制</a>
                                    </h4>
                                </li>
                                <li>
                                    <h4 onClick="commaction(4)">
                                       <a href="javascript:void(0);">产品疑问</a>
                                    </h4>
                                </li>
                                <li>
                                    <h4 onClick="commaction(5)">
                                       <a href="javascript:void(0);">关于定制</a>
                                    </h4>
                                </li>
                                <li>
                                    <h4 onClick="commaction(6)">
                                        <a href="javascript:void(0);">关于运输</a>
                                    </h4>
                                </li>
                                <li>
                                    <h4>
                                        <a onClick="commaction(7)" href="javascript:void(0);">关于售后</a>
                                    </h4>
                                </li>
                            </ul>
                            <!--里面的ul end-->
                    ...
                    <div class="ques_right fl">
                        <!--购买流程的问题-->
                        <div class="buy_question" style="display: block;"><div>
	钻石挑选是钻戒购买中最重要的一个环节，您可以参照如下方法，挑选最合适您的钻石。</div>
<div>
	&nbsp;</div>
<div>
	<strong>一、制定合理的预算</strong></div>
<div>
	&nbsp; &nbsp; 钻戒的价格主要由钻石决定，所以在挑选DR钻戒前，您需要知道选择多大的一枚钻石才会让爱人满意，朋友羡慕，又不会显得过分奢侈，不会让自己感到经济上的压力。</div>
<div>
	&nbsp; &nbsp; 按照国际惯例，一枚钻戒的合理预算，大致是男性3个月的工作收入，如此安排，既符合礼仪，也符合身份，还会让你的恋人觉得倍感甜蜜。当然，这只是一个参考，对于一生一次的求婚，对于无比珍贵的承诺来说，每个人都有自己不同的表达方式，预算制定也因人而异。</div>
<div>
	&nbsp;</div>
<div>
	<strong>二、选择合适恋人特点的钻石</strong></div>
<div>
	钻石主要的参数有颜色，切工，净度，重量。</div>
<div>
	如果你是专业人士，请参考对各项指标的详细描述，进行自主搭配：<a href="index.htmlbrand.html_sc"><span style="color:#000;">钻石4C等级</span></a></div>
<div>
	&nbsp;</div>
<div>
	如果你不太懂钻石，简单说来，你可以按照女孩子的性格来选择钻石：</div>
<div>
	&nbsp;&nbsp;&nbsp;&nbsp; 恋人是比较外向，充满活力喜欢活跃在社交场合的女孩子来说，首先关注钻石大小，0.5克拉左右的比较合适，如果预算有限，可以适当选择切工和净度参数稍低的。</div>
<div>
	&nbsp; &nbsp;&nbsp;<span style="white-space:pre" class="Apple-tab-span"> </span>恋人是比较心细温柔的女孩，首先关注钻石净度和切工，IF净度加EX的切工是最好搭配，对于这样一枚珍贵的戒指来说，要经得起细细看，宁可选择不大，但却晶莹剔透毫无杂质的钻石，它就像你的爱一样纯净。</div>
<div>
	&nbsp; &nbsp;&nbsp; 恋人是比较内向安静的女孩子，首先关注色泽和净度，D色或E色会看上去更加洁白纯粹，从内在透露出不惹人瞩目却又让人难忘的光彩，就像安静女孩纯净的内心。</div>
<div>
	&nbsp;&nbsp;&nbsp;&nbsp; 恋人充满优雅气质，经常与你相伴出席社交场合的，请首选一克拉或以上的钻石，F色VVS1,3EX的搭配是最合适的。这样的钻石，会让你的爱人自信又光彩闪耀，也经的起好友玩伴的细细鉴赏品味。</div>
</div>
                        <!--购买流程的问题end-->
                        <!--常见问题-->
                        <div class="common_question" style="display: none;">
                            <h3 id="commonqudestion">官网店铺：</h3>
                            <ul class="com-question"><li><h4><span style="margin-top:8px;">Q：Darry Ring 是否有实体店？</span></h4><div style="display: block"><p><span style="margin-top:1px;">A：DR公司总部在香港，目前内地深圳市、北京市、重庆市、广州市、上海市、武汉市、南京市、长沙市设有实体店，支持到店订购，也支持全国在线官网订购。同时目前其他一线城市公司已在考察选址阶段，将陆续开设店面。</span></p></div></li><li><h4><span style="margin-top:8px;">Q：实体店具体位置？</span>
</h4><div><p><span style="margin-top:1px;">A：深圳实体店地址：深圳南山区世界之窗旁欧陆小镇4号楼Darry Ring （地铁罗宝线世界之窗I出口）深圳店联系方式：0755-86621782。</span></p>
...
全国400客服热线：400 01 13520。<p></p></div></li><li><h4><span style="margin-top:8px;">Q：到店订购和官网订购的价格一致吗？</span></h4><div><p><span style="margin-top:1px;">A：DR的所有商品，到店订购和官网订购的时间周期，价格，质量及售后服务均一致。</span>
</p></div></li><li><h4><span style="margin-top:8px;">Q：价格是否有折扣优惠？</span></h4><div><p><span style="margin-top:1px;">A：DR的品牌寓意为一生唯一真爱，大多是用作见证彼此求婚或结婚这一神圣时刻，所以所有商品都是常年任何节假日没有折扣活动，就像彼此一生唯一真爱的承诺及永恒的爱情，永不打折。</span>
</p></div></li><li><h4><span style="margin-top:8px;">Q：为什么在官网上输入姓名身份证号后看不到款式？</span></h4><div><p><span style="margin-top:1px;">A：www.darryring.com 官网首页点击&mdash;求婚钻戒，进入页面后不需要填写任何信息，移动鼠标到最下方，就可以看到Darry Ring女戒的所有款式。</span>
</p></div></li><li><h4><span style="margin-top:8px;">Q：到实体店是否可以立刻拿到戒指？</span></h4><div><p><span style="margin-top:1px;">A：您好，DR的所有商品都是需要根据您选择的款式、手寸大小及刻字信息来定制。实体店仅提供款式体验及预订，与官网购买的定制时间是一致的，可于15-20个工作日内送到或自取。</span>
</p></div></li><li><h4><span style="margin-top:8px;">Q：哪些电商平台可以购买到DR正品？</span>
</h4><div><p></p><p>
	<span style="margin-top:8px;">A：戴瑞目前开通电商平台有：亚马逊、京东、天猫、一号店等电商平台？</span></p>
<p>&nbsp;
	</p>
<p>
	<span style="margin-top:8px;"><a href="http://darryring.tmall.com/?spm=a220o.1000855.1997427721.d4918089.bGtU16"><img width="201" height="85" src="images/20150707101641f9d958efff.jpg" alt=""></a>&nbsp;<a href="http://search.jd.com/search?keyword=%E7%8F%A0%E5%AE%9D&enc=utf-8&qrst=1&ps=addr&rt=1&stop=1&ev=exbrand_DR%20darryring%40&uc=0"><img width="201" height="85" src="images/2015070710170180545692fd.jpg" alt=""></a>&nbsp;<a href="http://list.yhd.com/c0-0-0/b969402-30038/a-s1-v4-p1-price-d0-f0-m1-rt0-pid-mid0-k%E7%8F%A0%E5%AE%9D/"><img width="201" height="85" src="images/20150707101711e7690bde7f.jpg" alt=""></a>&nbsp;<a href="http://www.amazon.cn/s/ref=sr_nr_i_0?fst=as%3Aoff&rh=k%3ADarry+Ring%2Ci%3Ajewelry&keywords=Darry+Ring&ie=UTF8&qid=1436234715"><img width="201" height="85" src="images/20150707101722a3e63ffc72.jpg" alt=""></a></span></p>
<p></p></div></li></ul></div>
                        <!--常见问题end-->
                    </div>
                    <!--右边end-->

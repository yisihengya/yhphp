<html class="hb-loaded"><head>
    ...
    <meta name="Description" content="Darry Ring官网会员注册登录唯一入口，Darry Ring是求婚钻戒第一品牌，想了解Darry Ring实体店、Darry Ring哪里有卖等相关Darry Ring资讯就先进入戴瑞珠宝官网注册吧！">
    	            ...
    	            <link href="{{asset('libs/home')}}/css/style.css" type="text/css" rel="stylesheet"/>
        </head>
...
<body>
	...
	<div class="head_top">
        <div class="head clearfix">
            ...
            <div class="topLeft left">
                <a href="{{asset('home/index')}}" title="Darry Ring">
                    <img width="186" height="42" src="{{asset('libs/home')}}/images/logo_01.png ">
                </a>
                <span>求婚钻戒领导品牌</span>
            </div>
            <!--头部左边end-->
        ...
        <div class="cmain ddd">
            ...
            <div class="cort-right right">
                ...
                <div class="cr_border">
                    ...
                    <!--手机注册-->
                    <form method="post" action="" class="form_first">
                        {{csrf_field()}}
                    ...
                    <div style="" class="photo_show">
                        ...
                        <div class="the_input">
                           ...
                           <input type="text" placeholder="请输入手机号码" class="al_Input dr_photo" value="{{old('mobile')}}" name="mobile"><p>{{$errors->first('mobile')}}</p>
                        </div>
                        <!--邮箱end-->
                        <!--密码-->
                        ...
                        <div class="the_input ">
                           <span class="pw"></span>
                           <input type="password" placeholder="请输入密码" maxlength="21" class="al_Input dr_photo" value="{{old('pwd')}}" name="pwd"><p>{{$errors->first('pwd')}}</p>
                        </div>
                        <!--密码end-->
                        <!--密码-->
                        <div class="the_input ">
                           <span class="pw"></span>
                           <input type="password" placeholder="确认密码" maxlength="21" class="al_Input dr_photo" value="{{old('pwd_confirm')}}" name="pwd_confirmation"><p>{{$errors->first('pwd')}}</p>
                        </div>
                        <!--密码end-->
                        ...
                        <!--其他合作-->
                        <div class="other_hz">
                            <input type="submit" value="立即注册" id="mobile_reg" class="up" name="phonesub">
                        </div>
                        <!--其他合作end-->
                    </div>
                    </form>
                    ...
                    <!--邮箱注册-->
                    <form method="post" action="" class="form_second">
                    ...
                    <div style="display:none" class="photo_show">
                        ...
                        <div style="border:none" class="the_input">
                            <span class="password"></span>
                            <input type="text" style="width:93px;"  class="al_Input ls" value="" name="email_code">
                            <div class="action_code"><a title="点击刷新验证码" href="javascript:void(1)"><img onClick="javascript:this.src = {{asset('libs/home/code')}} + Math.random();" src="{{asset('libs/home/code?')}}"></a></div>
                        </div>
                                                <!--验证码end-->
                        ...
                        <div class="left">
                            ...
                            <label for="email_check">已经仔细阅读并同意<a target="_blank" href="{{url('libs/home/index/help_us/49')}}">《Darry Ring用户注册协议》</a></label>
                        </div>
                        </div>
                        
                        <!--其他合作-->
                        <div class="other_hz">
                            <input type="submit" value="立即注册" id="email_reg" class="up" name="emailsub">
                        </div>
                        <!--其他合作end-->
                    </div>
                    </form>
                         <div><span style="font-size: 12px; display: inline-block;padding-top: 10px;float:left;margin-left: 176px; ">已经有账号，</span><span style="color: #8e4f1b; font-size: 12px; display: inline-block; float: right; margin-right: 42px; padding-top: 10px;"><a href="{{asset('home/login')}}">立即登录</a></span></div>
                    <!--邮箱注册end-->
                </div>
                <!--登陆框内end-->
            </div>
    ...
    <div class="cmain bc_yz">
        <div class="db_cort">
            <p>Copyright &copy; 2006-2019 www.darryring.com 戴瑞珠宝 All Rights Reserved. 粤ICP备11012085号</p>
